...
options = { \
    ...
    'libraryview'               :('Grid', 'Paged Grid', 'Overview', 'OverviewPaged', 'List', 'Hide'), \
    'sharedlibrariesview'       :('Grid', 'Paged Grid', 'Overview', 'OverviewPaged', 'List', 'Hide'), \
    'librariesview'             :('Hide', 'Grid', 'Paged Grid', 'Overview', 'OverviewPaged', 'List'), \
